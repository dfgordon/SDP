...
60  C = 1: HCOLOR = C
70  BY = 19456
80  VTAB 21: INPUT "HARD CODE BRUSH SET (Y/N) ? ";A$
...
101  HOME
105  XDRAW NS AT X,Y
110  HTAB 1: VTAB 21: PRINT "X=";X;" , Y=";Y;: CALL -868
...
510  PRINT: PRINT "NEW COLOR: ";
520  GET A$: C =  VAL (A$): IF C < 0 OR C > 7 THEN 520
540  HCOLOR = C: HOME: RETURN
...
1005  PRINT: INPUT "DOWN HOW MANY: ";ZA
...
1130  CALL 19200: REM INVOKE INTEPRETER
1199  RETURN
...
1300  REM UNDO MANY
1310  PRINT: INPUT "UNDO HOW MANY STEPS: ";S
1320  BY = BY - (S * 8)
1330  GOSUB 1100
1399  HOME: RETURN

1400  REM REWIND
1410  PRINT: INPUT "REWIND AND INSERT AT STEP# ";S
1420  OLD = BY
1430  BY = 19456 + (S * 8)
1440  GOSUB 1100
1499  HOME: RETURN
...
1610  PRINT: INPUT "DRAW HOW MANY STEPS? ";S
1620  OLD = BY
1630  BY = 19456 + (S * 8)
1640  BN =  PEEK (BY)
1650  GOSUB 1100
...
1720  PRINT: INPUT "STEP UP/DOWN: ";ZD
...
1810  GOSUB 3000
1820  PRINT: PRINT CHR$(4);"BLOAD ";A$;",A$2000,S";S;",D";D;",V";V
1830  RETURN
...
8010  GOSUB 3000
8020  PRINT: PRINT  CHR$ (4);"BLOAD ";A$;",A";BY;",S";S;",D";D;",V";V
8030  BY = 19456
8040  X =  PEEK (BY): IF X = 96 THEN 8060
8050  BY = BY + 8: GOTO 8040
8060  GOSUB 1100: HOME: RETURN
...
30155  PRINT  CHR$ (4);"BSAVE ";A$;",A19456,L";BY - 19456;",S";S;",D";D;",V";V
30160  PRINT "INSERT SDP IN ";ST$
30170  INPUT "PRESS ENTER WHEN READY";A$
30180  PRINT CHR$(4);"RUN HELLO,";ST$
